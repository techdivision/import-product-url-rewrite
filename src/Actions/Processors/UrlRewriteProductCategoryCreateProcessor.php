...
/**
 * TechDivision\Import\Product\UrlRewrite\Actions\Processors\UrlRewriteProductCategoryCreateProcessor
 *
 * NOTICE OF LICENSE
 *
...
class UrlRewriteProductCategoryCreateProcessor extends AbstractCreateProcessor
{
    ...
    protected function getStatements()
    {
        ...
        return array(
            SqlStatementKeys::CREATE_URL_REWRITE_PRODUCT_CATEGORY => $this->loadStatement(SqlStatementKeys::CREATE_URL_REWRITE_PRODUCT_CATEGORY)
        );
    }
}
